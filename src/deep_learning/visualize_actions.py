...
# csv_file_name='IMG_0881_60_best_hybrid_model_vgg19_prediction_parallel.csv'
...
d = vec1[vec1!= -1]
max_val, min_val=calculate_max_min(d)
d=min_max_scaling(d,max_val,min_val)
sigma=1.5
# res_0 = abs(ndimage.gaussian_laplace(vec0, sigma=sigma))
res_1 = abs(ndimage.gaussian_laplace(d, sigma=sigma))
